...
<header class="bg-onyx p-4 z-50">
    ...
    <div class="max-w-[1000px] mx-auto px-4 pb-2">
        ...
        <!-- Navigation Bar -->
        <div class="bg-seasalt shadow-[0_35px_60px_-15px_rgba(255,255,255,0.5)] dr z-50 absolute left-0 text-md py-4 px-8 w-full max-w-screen-lg rounded-md md:absolute md:left-1/2 md:top-[85px] md:-translate-x-1/2 md:text-[13.5px] lg:text-[16px]"
    >
        
            <nav
                class="md:flex md:justify-between md:flex-row-reverse md:items-center gap-6 relative z-50"
            >
                <!-- Navigation Links -->
                <div class="flex items-center justify-between">
                    ...
                    <div class="relative [&>div>aside]:hover:block">
                        ...
                        >
                            <input
                                class="rounded-md w-full md:w-auto p-1 md:p-2"
                                type="text"
                                placeholder="Søg"
                            ...
                            <button>
                                <SearchIcon
                                    class="absolute top-[10px] md:top-[15px] right-4 stroke-1 cursor-pointer"
                                    size="14"
                                />
                            </button>
                        </form>
